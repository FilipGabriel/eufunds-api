...
namespace Smis\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use Smis\Scaffold\Module\Generators\FilesGenerator;
use Smis\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \Smis\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \Smis\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \Smis\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \Smis\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The SMIS {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The SMIS {$moduleName} Module.\"," . PHP_EOL;
