                        ...
                        >
                            ...
                            <tr>
                                <td style="padding: 0;">
                                    <span style="font-family: 'Open Sans', sans-serif;
                                                ...
                                                display: block;"
                                    >
                                        {{ trans('user::mail.verify_your_email') }}
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding: 30px 0; text-align: center;">
                                    ...
                                    >
                                        {{ trans('user::mail.activate_your_account') }}
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding: 23px 0 0;">
                                    ...
                                    >
                                        {{ trans('user::mail.if_you\’re_having_trouble', ['button_name' => trans('user::mail.activate_your_account')]) }}
                                    </span>
                                </td>
                            </tr>
