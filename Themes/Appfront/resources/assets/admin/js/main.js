window.admin.removeSubmitButtonOffsetOn([
    ...
    '#brands', '#two_column_banners', '#three_column_banners', '#one_column_banner', '#video_tutorial'
]);

$('#appfront_theme_color').on('change', (e) => {
...
$('#appfront_mail_theme_color').on('change', (e) => {
    if (e.currentTarget.value === 'custom_color') {
...
$('#appfront-settings-edit-form').on('click', '.panel-image', (e) => {
