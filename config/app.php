...
return [
    ...
    */
    'name' => 'EUFunds',
    'frontend_domain' => env('FRONTEND_DOMAIN', 'eufunds.ro'),
...
//        Illuminate\Session\SessionServiceProvider::class,
         ...
         */
        Smis\Providers\AppServiceProvider::class,
        Smis\Providers\EventServiceProvider::class,
        Smis\Providers\RouteServiceProvider::class,
