...
if (! function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('smis.modules.core.config.core_modules'));
    }
}
...
if (! function_exists('smis_version')) {
    /**
     * Get the smis version.
     *
     * @return string
     */
    function smis_version()
    {
        return Smis::VERSION;
    }
}
