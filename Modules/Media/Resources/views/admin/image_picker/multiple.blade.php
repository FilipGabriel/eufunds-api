<div class="multiple-images-wrapper">
    ...
    <button type="button" class="image-picker btn btn-default" data-input-name="{{ $inputName }}" data-multiple data-location="{{ $location }}">
                    ...
                    @else
                        @foreach ($files as $file)
                            <div class="image-holder">
                                <img src="{{ $file->path }}">
                                <button type="button" class="btn remove-image" data-input-name="{{ $inputName }}" data-location="{{ $location }}"></button>
